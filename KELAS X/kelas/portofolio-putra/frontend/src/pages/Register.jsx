      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full py-3 px-6 rounded-lg text-white font-medium bg-gradient-to-r from-neon-purple to-neon-pink hover:opacity-90 transition-opacity duration-300 mt-6 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
